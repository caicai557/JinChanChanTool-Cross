...
{
    partial class EquipmentDataEditorForm
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            dataGridView_装备数据编辑器 = new DataGridView();
            ...
            panel1 = new Panel();
            ((System.ComponentModel.ISupportInitialize)dataGridView_装备数据编辑器).BeginInit();
            ...
            // 
            dataGridView_装备数据编辑器.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            dataGridView_装备数据编辑器.Location = new Point(5, 35);
            dataGridView_装备数据编辑器.Name = "dataGridView_装备数据编辑器";
            dataGridView_装备数据编辑器.Size = new Size(711, 395);
            dataGridView_装备数据编辑器.TabIndex = 0;
            dataGridView_装备数据编辑器.CellContentClick += dataGridView1_CellContentClick;
            // 
            // button_添加
            // 
            ...
            panel_DataGridView.Controls.Add(dataGridView_装备数据编辑器);
            ...
            Text = "装备数据文件编辑器";
            Load += EquipmentDataEditorForm_Load;
            ((System.ComponentModel.ISupportInitialize)dataGridView_装备数据编辑器).EndInit();
        ...
        private DataGridView dataGridView_装备数据编辑器;
